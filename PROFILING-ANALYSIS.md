...
| # | Hypothesis | Profile Evidence | Impact | Fix Effort |
|---|-----------|-----------------|--------|------------|
| 1 | String-as-array representation | ArrayJoin 1.2%, RegExpSplit, reader char ops | HIGH | HIGH |
| 2 | Exceptions for local control flow | CompileLazy 3.2%, 194 try/catch | HIGH | MEDIUM |
| 3 | Megamorphic IC thrashing | LoadIC **13.4%**, KeyedHasIC 1.9%, StoreIC 1.4% | HIGH | HIGH |
| 4 | Pervasive IIFE wrapping | CompileLazy 3.2%, 7,239 IIFEs | MEDIUM | MEDIUM |
| 5 | N-scan keyword argument parsing | 553 loops, ASSOC 4.3% | MEDIUM | LOW |
| 6 | Redundant arithmetic type checks | 1,548 typeof guards | MEDIUM | MEDIUM |
| 7 | NIL comparison overhead | StrictEqual 2.0%, 8,289 refs | LOW-MED | LOW |
| 8 | Function call indirection | 436 typeof dispatches in hot loops | LOW-MED | MEDIUM |
| 9 | VALID-JS-IDENTIFIER hot path | ALPHANUMERICP **2.7%** | LOW-MED | LOW |
| 10 | ASSOC in compiler environments | ASSOC **4.3%** (#2 JS hotspot) | LOW-MED | MEDIUM |
