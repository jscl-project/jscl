...
;;; FSET section
(fset 'class-of (fdefinition '!class-of))
(fset 'class-name (fdefinition '!class-name))
(fset 'find-class (fdefinition '!find-class))
(fset 'slot-value (fdefinition '!slot-value))
(fset 'slot-boundp (fdefinition '!slot-boundp))
(fset 'slot-makunbound  (fdefinition '!slot-makunbound))
(fset 'slot-exists-p  (fdefinition '!slot-exists-p))
(fset 'slot-exists-p  (fdefinition '!slot-exists-p))
(fset 'ensure-generic-function (fdefinition '!ensure-generic-function))
(fset 'find-method (fdefinition '!find-method))
(fset 'add-method (fdefinition '!add-method))
(fset 'remove-method (fdefinition '!remove-method))
(fset 'method-qualifiers (fdefinition '!method-qualifiers))
(fset 'method-specializers (fdefinition '!method-specializers))
